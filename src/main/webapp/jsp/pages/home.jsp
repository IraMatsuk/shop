...
<div class="page">
    ...
    <div class="container-fluid justify-content-center">
        ...
        <p class="text-center"><b><fmt:message key="cafe.kitchen"/> </b></p>
        <p>

        </p>
        <fmt:message key="cafe.kitchen_text_one"/>
        <p>
            <fmt:message key="cafe.kitchen_text_two"/>
        </p>
        <p class="text-center">
            <fmt:message key="cafe.the_end"/>
        </p>
